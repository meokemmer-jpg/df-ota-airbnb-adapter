"""W41-A Idempotency-Integration-Tests fuer airbnb-ota [CRUX-MK]."""
...
from src.airbnb_adapter import AirbnbConnector  # noqa: E402
...
@pytest.fixture
def adapter():
    a = AirbnbConnector(sandbox_mode=True)
