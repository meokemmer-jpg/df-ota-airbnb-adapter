"""Commission-Tracker fuer Airbnb [CRUX-MK].

Trackt 3%-Host-Kommission pro Booking + Aggregat-Reports.
...
class CommissionTracker:
    ...
    COMMISSION_PCT_DEFAULT = 0.03

    def __init__(self, df_id: str = "df-ota-airbnb-adapter", storage_dir: str = "audit"):
        self.df_id = df_id
    ...
    def record_booking(self, booking: dict) -> CommissionRecord:
        ...
        try:
            ...
            record = CommissionRecord(
                ...
                vendor=booking.get("vendor", "airbnb"),
            )
